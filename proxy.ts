...
export const config = {
  matcher: [
    '/((?!api/auth|api/cron|api/health|api/system|api/uploads|api/sign|api/webhooks|api/public|api/external|sign|jobs|_next/static|_next/image|favicon.ico|auth/signin|auth/error|demo-).*)',
  ],
}
